...
def get_meta() -> OpMetaModel:
    return OpMetaModel(
        Name="多模态深度思考模型（Doubao-Seed-1.6-flash）",
...
def get_extra_meta() -> ExtraMetaModel:
    code = f"https://{OP_BUCKET}.tos-{OP_REGION}.volces.com/{OP_ENVIRONMENT}/operator_cards/{OP_VERSION}/doubao-seed-1.6-flash/doubao-seed-1.6-flash.py"
    code_description = (
        "下面的代码展示了如何使用 daft"
