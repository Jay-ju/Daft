...
def get_extra_meta() -> ExtraMetaModel:
    code = f"https://{OP_BUCKET}.tos-{OP_REGION}.volces.com/{OP_ENVIRONMENT}/operator_cards/{OP_VERSION}/doubao-1.5-thinking-vision-pro/doubao-1.5-thinking-vision-pro.py"
    code_description = (
        "下面的代码展示了如何使用 daft"
