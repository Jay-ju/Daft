...
def get_meta() -> OpMetaModel:
    return OpMetaModel(
        Name="文本向量化（Doubao-embedding-large）",
...
def get_extra_meta() -> ExtraMetaModel:
    code = f"https://{OP_BUCKET}.tos-{OP_REGION}.volces.com/{OP_ENVIRONMENT}/operator_cards/{OP_VERSION}/doubao-embedding-large/doubao-embedding-large.py"
    code_description = (
        "下面的代码展示了如何使用 daft"
