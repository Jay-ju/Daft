...
class MCAPScanOperator(ScanOperator):
    def __init__(
        ...
        from daft.filesystem import _resolve_paths_and_filesystem, list_files, normalize_storage_path
        ...
        [resolved_path], fs = _resolve_paths_and_filesystem(file_path, io_config=io_config)
        self._file_paths = [normalize_storage_path(file_path, io_config) for file_path in list_files(fs, resolved_path)]
